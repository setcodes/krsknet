			...
			<div className="flex flex-col justify-center gap-5 mt-10 px-0 xl:px-20 container">
				...
				<div className="flex flex-col lg:flex-row w-full justify-center gap-5">
					<div className="flex flex-col w-full gap-5 lg:gap-10 border border-borderKrsknet rounded-xl py-10 px-10 w-12/12 lg:w-4/12">
						...
						<div className="flex gap-2 xl:gap-0 justify-between items-center mx-10">
							<div>
								<Image
							...
							<div className=" text-1xl lg:text-2xl font-light text-center">
								Для 1-го устройства
							</div>
						</div>
						<div className="flex  gap-2 xl:gap-0 justify-between items-center mx-10">
							...
							<div className="text-1xl lg:text-2xl font-light text-center">
								<span className="text-2xl lg:text-4xl  font-bold mr-2">
									1000
								</span>{' '}
								Руб. Месяц
							</div>
					...
					<div className="flex flex-col w-full gap-5 lg:gap-10 rounded-2xl py-10 px-10 w-12/12 lg:w-4/12 bg-gradient-to-b from-red-700 to-zinc-800 to-90% ">
						...
						<div className="flex justify-center">
							<div className="text-1xl lg:text-3xl text-white">
						...
						<div className="flex  gap-2 xl:gap-0 justify-between items-center mx-10">
							...
							<div className="text-1xl lg:text-2xl font-light text-white text-center">
								Для 1-2x устройств
							</div>
						</div>
						<div className="flex gap-2 xl:gap-0 justify-between items-center mx-10">
					...
					<div className="flex flex-col w-full gap-5 lg:gap-10 border border-borderKrsknet rounded-xl py-10 px-10 w-12/12 lg:w-4/12">
						...
						<div className="border border-borderWhiteOrBlack"></div>
						<div className="flex flex-row gap-2 xl:gap-0 justify-between items-center mx-10">
							<div>
								<Image
									src={'./img/internet.svg'}
									alt="количество устройств"
